Public Class DaftarOrderForm
    Dim conn As New SqlClient.SqlConnection
    Dim rd As SqlClient.SqlDataReader
    Dim fcn As New FunctionClass
    Private Sub DaftarOrderForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub refreshData()
        Dim sql As String = "SELECT id_order,total_harga ,tanggal_order FROM tbl_order WHERE id_user = '" + Me.Tag + "' AND is_accept = 0"
